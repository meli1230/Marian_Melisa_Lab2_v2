...
builder.Services.AddDbContext<LibraryIdentityContext>(options => options.UseSqlServer(
    builder.Configuration.GetConnectionString(
        "Marian_Melisa_Lab2Context") ?? throw new InvalidOperationException(
            "Connection string 'Marian_Melisa_Lab2Context' not found.")));

...
namespace Marian_Melisa_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Marian_Melisa_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Marian_Melisa_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
